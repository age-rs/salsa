...
## [0.22.0](https://github.com/age-rs/salsa/compare/salsa-v0.21.1...salsa-v0.22.0) - 2025-05-20

### Fixed

- fix memo table growth condition ([#850](https://github.com/age-rs/salsa/pull/850))
- incorrect caching for queries participating in fixpoint ([#843](https://github.com/age-rs/salsa/pull/843))
- change detection for fixpoint queries ([#836](https://github.com/age-rs/salsa/pull/836))

### Other

- Implement an `!Update` bound escape hatch for tracked fn ([#867](https://github.com/age-rs/salsa/pull/867))
- Only enable `boxcar/loom` when `loom` feature is enabled ([#869](https://github.com/age-rs/salsa/pull/869))
- Remove default `PartialOrd` and `Ord` derives for salsa-structs ([#868](https://github.com/age-rs/salsa/pull/868))
- update boxcar ([#865](https://github.com/age-rs/salsa/pull/865))
- speed-up cycle-retry logic ([#861](https://github.com/age-rs/salsa/pull/861))
...
- Work around a rust-analyzer bug ([#855](https://github.com/age-rs/salsa/pull/855))
- Lazy finalization of cycle participants in `maybe_changed_after` ([#854](https://github.com/age-rs/salsa/pull/854))
- Do not re-verify already verified memoized value in cycle verification ([#851](https://github.com/age-rs/salsa/pull/851))
- Pass cycle heads as out parameter for `maybe_changed_after` ([#852](https://github.com/age-rs/salsa/pull/852))
- Move salsa event system into `Zalsa` ([#849](https://github.com/age-rs/salsa/pull/849))
- gate loom dependency under feature flag ([#844](https://github.com/age-rs/salsa/pull/844))
