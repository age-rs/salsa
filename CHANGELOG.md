...
## [0.19.0](https://github.com/age-rs/salsa/compare/salsa-v0.18.0...salsa-v0.19.0) - 2025-03-09
...
- Group versions of packages together for releases ([#751](https://github.com/age-rs/salsa/pull/751))
- use `portable-atomic` in `IngredientCache` to compile on `powerpc-unknown-linux-gnu` ([#749](https://github.com/age-rs/salsa/pull/749))
- Store view downcaster in function ingredients directly ([#720](https://github.com/age-rs/salsa/pull/720))
- Some small perf things ([#744](https://github.com/age-rs/salsa/pull/744))
- :replace instead of std::mem::replace ([#746](https://github.com/age-rs/salsa/pull/746))
- Cleanup `Cargo.toml`s ([#745](https://github.com/age-rs/salsa/pull/745))
